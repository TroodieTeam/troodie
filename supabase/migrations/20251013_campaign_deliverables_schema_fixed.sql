-- =============================================
-- Campaign Deliverables System - Fixed Schema
-- Date: 2025-10-13
-- Description: Updates existing campaign_deliverables table and adds new tables
-- =============================================

-- =============================================
-- DROP AND RECREATE CAMPAIGN_DELIVERABLES TABLE
-- (The existing table has incompatible structure)
-- =============================================
...
-- Add deliverable tracking to campaign_applications (if columns don't exist)
DO $$
BEGIN
...
-- Add deliverable counters to campaigns (if columns don't exist)
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns
...
-- Add Stripe fields to creator_profiles (if columns don't exist)
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns
