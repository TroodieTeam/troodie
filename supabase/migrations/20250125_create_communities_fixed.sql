-- Migration: Create Communities System (Fixed)
...
DROP FUNCTION IF EXISTS create_community CASCADE;
DROP FUNCTION IF EXISTS join_community CASCADE;
DROP FUNCTION IF EXISTS get_user_restaurant_rating CASCADE;
DROP FUNCTION IF EXISTS ensure_quick_saves_board CASCADE;
