...
SELECT 'campaign-content', 'campaign-content', false, 104857600, -- 100MB limit
...
-- Creators can upload content to their own campaign folders
...
-- Creators can view their own uploaded content
...
-- Creators can delete their own content (for re-upload before review)
...
-- =============================================
-- Current policy only allows updates on 'draft' status deliverables.
-- We need to also allow updates on 'pending_review' (for re-upload)
-- and 'approved' (for proof link submission).
